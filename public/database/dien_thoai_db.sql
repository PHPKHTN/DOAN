...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 11, 2017 lúc 07:13 CH
...
ALTER TABLE `hang_san_xuat`
  ADD PRIMARY KEY (`ma_hang_san_xuat`);
...
ALTER TABLE `san_pham`
  ...
  ADD KEY `ma_trang_thai` (`ma_trang_thai`),
  ADD KEY `ma_trang_thai_2` (`ma_trang_thai`);
...
--
ALTER TABLE `hang_san_xuat`
  MODIFY `ma_hang_san_xuat` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT cho bảng `hinh_san_pham`
--
ALTER TABLE `hinh_san_pham`
  MODIFY `ma_hinh` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=136;
--
...
--
ALTER TABLE `loai_san_pham`
  MODIFY `ma_the_loai` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT cho bảng `san_pham`
--
ALTER TABLE `san_pham`
  MODIFY `ma_san_pham` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=87;
--
-- AUTO_INCREMENT cho bảng `tin_tuc`
--
ALTER TABLE `tin_tuc`
  MODIFY `ma_tin` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT cho bảng `trang_thai`
--
ALTER TABLE `trang_thai`
  MODIFY `ma_trang_thai` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
