...
<div class="prod-items section-items">
				...
				<div class="prod-i">
					<div class="prod-i-top">
						<a href="product.html" class="prod-i-img"><!-- NO SPACE --><img src="public/images/san_pham/<?php echo $dt->hinh; ?>" alt="Adipisci aperiam commodi"><!-- NO SPACE --></a>
						<p class="prod-i-info">
					...
					<h3>
						<a href="product.html"><?php echo $dt->ten_san_pham; ?></a>
					</h3>
