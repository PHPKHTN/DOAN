<!-- Single Product - start -->
		<div class="prod-wrap">
					...
					<ul class="prod-slider-car">
						<li>
							<a data-fancybox-group="product" class="fancy-img" href="http://placehold.it/500x642">
								<img src="public/images/san_pham/{$dien_thoai->hinh}" alt="">
							</a>
						</li>
			...
			<div class="prod-cont">
				<h1 class="main-ttl"><span>{$dien_thoai->ten_san_pham}</span></h1>
				...
				<div class="prod-info">
					<p class="prod-price">
						<b class="item_current_price">{$dien_thoai->don_gia}</</b>
					</p>
					<p class="prod-qnt">
					...
					<p class="prod-addwrap">
						<a href="javascript:void(0)" id="{$dien_thoai->ma_san_pham}" class="prod-add" rel="nofollow">Add to cart</a>
					</p>
				</div>
				<ul class="prod-i-props">
					<li>
						<b>{$dien_thoai->mo_ta}</</b> 05464207
					</li>
				</ul>
			</div>
