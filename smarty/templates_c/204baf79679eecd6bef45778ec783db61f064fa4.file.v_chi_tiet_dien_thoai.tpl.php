<?php /* Smarty version Smarty-3.1.18, created on 2017-11-25 08:12:26
					...
					<ul class="prod-slider-car">
						<li>
							<a data-fancybox-group="product" class="fancy-img" href="http://placehold.it/500x642">
								<img src="public/images/san_pham/<?php echo $_smarty_tpl->tpl_vars['san_pham']->value->hinh;?>
" alt="">
							</a>
						</li>
			...
			<div class="prod-cont">
				<h1 class="main-ttl"><span><?php echo $_smarty_tpl->tpl_vars['san_pham']->value->ten_san_pham;?>
</span></h1>
				...
				<div class="prod-info">
					<p class="prod-price">
						<b class="item_current_price"><?php echo $_smarty_tpl->tpl_vars['san_pham']->value->don_gia;?>
</</b>
					</p>
					<p class="prod-qnt">
				...
				<ul class="prod-i-props">
					<li>
						<b><?php echo $_smarty_tpl->tpl_vars['san_pham']->value->mo_ta;?>
</</b> 
					</li>
				</ul>
			</div>
			...
			<div class="prod-tabs-wrap">
				...
				<div class="prod-tab-cont">
					...
					<div class="prod-tab stylization" id="prod-tab-1">
						<p><?php echo $_smarty_tpl->tpl_vars['san_pham']->value->mo_ta;?>
</</p>
					</div>
